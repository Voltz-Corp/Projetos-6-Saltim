  ...
  return (
    ...
    >
      ...
      <div className="size-10 rounded-xl bg-brand-50 flex items-center justify-center ml-4 group-hover:bg-brand-600 transition-colors">
        <span className="text-brand-600 group-hover:text-white transition-colors">{icon}</span>
      </div>
    </button>
  )
}
    ...
    <div className="flex flex-col h-screen bg-surface overflow-auto">
      ...
      <div className="flex-1 p-8 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard value={critico + esgotado} label="Críticos / esgotados" color="#E4332B" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <ActionCard
            ...
            sub={`${total} insumos · ${CATEGORIES.length} categorias`}
            ...
            icon={
              <svg viewBox="0 0 20 20" className="size-5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="7" width="16" height="11" rx="1" /><path d="M5 7V5a5 5 0 0110 0v2" />
              </svg>
            }
          />
          <ActionCard
            title="Iniciar nova contagem"
            sub="Selecione uma categoria e registre as quantidades"
